...
[![Dipanshu ‎](https://miro.medium.com/v2/resize:fill:64:64/1*SToMouWcalbMTg3N3mERqQ.png)](https://dipanshu10.medium.com/?source=post_page---byline--a70ee26b4cbf---------------------------------------)

[Dipanshu ‎](https://dipanshu10.medium.com/?source=post_page---byline--a70ee26b4cbf---------------------------------------)
...
Thanks for reading this article through the end!

*If you enjoyed this article, tap that clap 👏 button 50 times! follow me on* [*X*](https://x.com/Dipanshu089) *for more insights and* [*Subscribe to my newsletter*](https://dipanshu10.medium.com/subscribe) *for FREE to be notified of new articles!   
Your thoughts and feedback are always welcome in the comments below*- *I read them all!.*

[## Get an email whenever Dipanshu ‎publishes.

### Get an email whenever Dipanshu ‎ publishes. By signing up, you will create a Medium account if you don’t already have…

medium.com](https://medium.com/@dipanshu10/subscribe?source=post_page-----a70ee26b4cbf---------------------------------------)
...
dipanshu10.medium.com](https://dipanshu10.medium.com/why-docker-might-not-be-your-best-choice-74beb3bcad74?source=post_page-----a70ee26b4cbf---------------------------------------)

[## Why Developers Are Ditching PostgreSQL, MySQL and MongoDB

### The Database Revolution Your Project Is Missing Out On

aws.plainenglish.io](/why-developers-are-ditching-postgresql-mysql-and-mongodb-b3b953ebe6b6?source=post_page-----a70ee26b4cbf---------------------------------------)
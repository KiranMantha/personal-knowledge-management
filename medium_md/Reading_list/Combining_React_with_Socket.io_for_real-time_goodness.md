---
title: "Combining React with Socket.io for real-time goodness"
url: https://medium.com/p/d26168429a34
---

# Combining React with Socket.io for real-time goodness

[Original](https://medium.com/p/d26168429a34)
...
[![Hendrik Swanepoel](https://miro.medium.com/v2/resize:fill:64:64/1*ExRrCjYNg707LcIHLkTWaQ.jpeg)](/@hendrikswan?source=post_page---byline--d26168429a34---------------------------------------)

[Hendrik Swanepoel](/@hendrikswan?source=post_page---byline--d26168429a34---------------------------------------)
...
```
import openSocket from 'socket.io-client';  
const  socket = openSocket('http://localhost:8000');function subscribeToTimer(cb) {  

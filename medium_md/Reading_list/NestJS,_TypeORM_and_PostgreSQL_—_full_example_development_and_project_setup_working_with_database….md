---
title: "NestJS, TypeORM and PostgreSQL — full example development and project setup working with database…"
url: https://medium.com/p/c1a2b1b11b8f
---

# NestJS, TypeORM and PostgreSQL — full example development and project setup working with database…

[Original](https://medium.com/p/c1a2b1b11b8f)

# **NestJS, TypeORM and PostgreSQL — full example development and project setup working with database migrations.**

[![Simon Gausmann](https://miro.medium.com/v2/resize:fill:64:64/1*ND2QCQYoRZkQYMHPKvmRlw.jpeg)](/@gausmann.simon?source=post_page---byline--c1a2b1b11b8f---------------------------------------)

[Simon Gausmann](/@gausmann.simon?source=post_page---byline--c1a2b1b11b8f---------------------------------------)
...
```
npm run start:dev:db:seed# gives us  
# done -> seed2302-1  
# done -> seed2302-2  
...
Here we saw how we can set up all the tooling to manage the database state locally.

From project setup, over models to hooking and working with the database.

All the tooling somehow relies on code and not going to some UI and setting things up by clicking buttons. With this “code” approach things are easy reproducible. Onboarding of new team members, or maybe for your self if you revisit the project 2 years from now and forgot how it was setup — will be really easy. You just have to run 3–4 commands to get started and to know how the commands work you can just look into to the files in the project, because all is there in code.

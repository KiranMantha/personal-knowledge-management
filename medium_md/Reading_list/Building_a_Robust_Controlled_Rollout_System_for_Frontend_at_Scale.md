...
url: https://medium.com/p/91cabeea2898
---

# Building a Robust Controlled Rollout System for Frontend at Scale

[Original](https://medium.com/p/91cabeea2898)

# Building a Robust Controlled Rollout System for Frontend at Scale

[![Ashoka Chandra Wardhan](https://miro.medium.com/v2/resize:fill:64:64/0*ZnhMuCr4_Yt3Dnne.jpg)](/@ashokawardhan?source=post_page---byline--91cabeea2898---------------------------------------)

[Ashoka Chandra Wardhan](/@ashokawardhan?source=post_page---byline--91cabeea2898---------------------------------------)
...
[Listen](/m/signin?actionUrl=https%3A%2F%2Fmedium.com%2Fplans%3Fdimension%3Dpost_audio_button%26postId%3D91cabeea2898&operation=register&redirect=https%3A%2F%2Fmedium.com%2Fswiggy-bytes%2Fbuilding-a-robust-controlled-rollout-system-for-frontend-at-scale-91cabeea2898&source=---header_actions--91cabeea2898---------------------post_audio_button------------------)
...
![User links to CloudFront, which serves file from S3. Then S3 serves the HTML file, which fetches JS/CSS from ImageKit. ImageKit internally again fetches from the same S3.]()
...
![Checks at Cloudfront level, whether the request falls in canary or not. If yes, routes to staging distribution which serves from the /canary folder]()
...
1. <https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/continuous-deployment.html>
...
[Mukesh Kabra](https://medium.com/u/6716e26f20d1?source=post_page---user_mention--91cabeea2898---------------------------------------)

, 

[Vaibhav Gupta](https://medium.com/u/2f88e7f467dc?source=post_page---user_mention--91cabeea2898---------------------------------------)

, 

[Rahul Dhawani](https://medium.com/u/a432091a1f67?source=post_page---user_mention--91cabeea2898---------------------------------------)

, 

[Tushar Tayal](https://medium.com/u/400467f4ffab?source=post_page---user_mention--91cabeea2898---------------------------------------)

, and my team for helping to take this live end to end.
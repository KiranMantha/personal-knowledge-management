...
url: https://medium.com/p/ea1d1b1e2ca1
---

# Localhost HTTPs: 3 Easy Ways to Secure Your Local Development Server

[Original](https://medium.com/p/ea1d1b1e2ca1)

# Localhost HTTPs: 3 Easy Ways to Secure Your Local Development Server

[![Robbie Cahill](https://miro.medium.com/v2/resize:fill:64:64/1*JUBsVyOjYoyBaqsEOeq0Uw.jpeg)](https://medium.com/@robbiecahill?source=post_page---byline--ea1d1b1e2ca1---------------------------------------)

[Robbie Cahill](https://medium.com/@robbiecahill?source=post_page---byline--ea1d1b1e2ca1---------------------------------------)
...
**The Major Drawback**: Browsers do not trust self-signed certificates by default. When you visit `https://localhost`, you will be greeted with a prominent security warning like "Your connection is not private" (NET::ERR\_CERT\_AUTHORITY\_INVALID).

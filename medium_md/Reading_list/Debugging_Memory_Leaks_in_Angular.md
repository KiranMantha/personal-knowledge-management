...
url: https://medium.com/p/4bc7b3eab569
---

# Debugging Memory Leaks in Angular

[Original](https://medium.com/p/4bc7b3eab569)

# Debugging Memory Leaks in Angular

## The situations where memory leaks are most likely to happen, and how you can deal with them using *Chrome DevTools.*

[![Giancarlo Buomprisco](https://miro.medium.com/v2/resize:fill:64:64/1*AIIoORiyf4Knk6jiyHgdQg.png)](https://medium.com/@.gc?source=post_page---byline--4bc7b3eab569---------------------------------------)

[Giancarlo Buomprisco](https://medium.com/@.gc?source=post_page---byline--4bc7b3eab569---------------------------------------)
...
export class ScrollComponent {  
  constructor(private renderer: Renderer2) {}  ngOnInit() {  
...
@Component({...})  
export class ScrollComponent {  
  private listeners = [];  constructor(private renderer: Renderer2) {}  ngOnInit() {  
...
export class PricerComponent  {  
  @Input() id: string;  public price$ = new Subject();  
...
* [Debugging Javascript Like a Pro](/debugging-javascript-like-a-pro-a2e0f6c53c2e)
...
blog.bitsrc.io](/sharing-components-with-angular-and-bit-b68896806c18?source=post_page-----4bc7b3eab569---------------------------------------)
...
blog.bitsrc.io](/the-state-of-angular-in-2019-b5fb7783a1c6?source=post_page-----4bc7b3eab569---------------------------------------)
...
blog.bitsrc.io](/11-angular-component-libraries-you-should-know-in-2018-e9f9c9d544ff?source=post_page-----4bc7b3eab569---------------------------------------)
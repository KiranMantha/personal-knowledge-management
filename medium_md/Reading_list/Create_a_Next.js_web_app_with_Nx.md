...
url: https://medium.com/p/bcf2ab54613
---

# Create a Next.js web app with Nx

[Original](https://medium.com/p/bcf2ab54613)

# Create a Next.js web app with Nx

[![Juri Strumpflohner](https://miro.medium.com/v2/resize:fill:64:64/1*s47HOlKyF5LEMdsNa6bGlw.png)](https://medium.com/@juristr?source=post_page---byline--bcf2ab54613---------------------------------------)

[Juri Strumpflohner](https://medium.com/@juristr?source=post_page---byline--bcf2ab54613---------------------------------------)
...
* **Create a Next.js web app with Nx**
* [Setup Next.js to use Tailwind with Nx](/setup-next-js-to-use-tailwind-with-nx-849b7e21d8d0?sk=de6c59dc84e8be204ef01f0f0c991edb)
* [Read and render Markdown files with Next.js and Nx](/read-and-render-md-files-with-next-js-and-nx-89a85c1d9b44?sk=e7b757c4d7351e5fe4bc314128f67a10)
* [Component hydration with MDX in Next.js and Nx](/component-hydration-with-mdx-in-next-js-and-nx-90f46ea0431c?sk=f66b1dbd930b8c4fcc061c6c019b2118)
* [Hot Reload MDX changes in Next.js with Nx](/hot-reload-mdx-changes-in-next-js-and-nx-c05252cf450a?sk=89c6755d55ed8e027d90cd0b98143d8b)
* [Using Nx Workspace generators to scaffold new blog posts](/using-nx-workspace-generators-to-scaffold-new-blog-posts-8c8162cf857b?sk=ec66d7d73cb31052d8981d7ee75d40a2)
* [Use Storybook with Next.js, Tailwind and Nx to develop components in isolation](/use-storybook-with-tailwind-in-an-nx-workspace-5ceb08edad71?sk=4a401b73f39c5c62cbda896776d2237b)
* [Use Cypress with Next.js and Nx to battle test your React Components](/use-cypress-with-next-js-and-nx-to-battle-test-your-react-components-da273f664f81?sk=c739a97960b93a6f7b0df3e7c1944735)
* [Publishing a Next.js site to Vercel with Nx](/publishing-a-next-js-app-to-vercel-with-nx-df81916548f5?sk=395c447331c55a6c0ea61964dda4fd7d)

[Follow us on Twitter](https://twitter.com/nxdevtools) or [subscribe to the newsletter](https://go.nrwl.io/nx-newsletter) to get notified when new articles get published.
...
Let’s give a fast overview of the main configuration files. All the details can be found on the official docs page: <https://nx.dev/reference/project-configuration>
...
> Note, we use `npx` in front because we don’t have Nx installed globally. Thus npx will fallback and execute the installed binary in our node\_modules folder. You can obviously also install Nx globally and get rid of having to prefix commands with `npx.`

---
title: "⏰ It’s Time to Talk About Import Map, Micro Frontend, and Nx Monorepo"
url: https://medium.com/p/0b8e2c07568a
---

# ⏰ It’s Time to Talk About Import Map, Micro Frontend, and Nx Monorepo

[Original](https://medium.com/p/0b8e2c07568a)

# ⏰ It’s Time to Talk About Import Map, Micro Frontend, and Nx Monorepo

## How leveraging native import map overrides can significantly benefit your micro frontend architecture

[![Jonathan Gelin](https://miro.medium.com/v2/resize:fill:64:64/1*OTDsb1IoU4b9Nt-3drrwEQ.png)](https://jgelin.medium.com/?source=post_page---byline--0b8e2c07568a---------------------------------------)

[Jonathan Gelin](https://jgelin.medium.com/?source=post_page---byline--0b8e2c07568a---------------------------------------)
...
The advent of [**esbuild**](https://esbuild.github.io/), the native support for [**ES Modules**](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Modules) in browsers, the widespread adoption of [**import map**](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/script/type/importmap), the emergence of tools like [**Native Federation**](https://www.angulararchitects.io/blog/announcing-native-federation-1-0/), and the [**Nx**](https://nx.dev/) ecosystem all combine to forge a flexible and well-maintained **Micro Frontend Architecture**.

**I’ll cover:**· [Real Story!](#e6e9)  
· [A short reminder about browsers](#017b)  
· [Micro frontend architecture in a nutshell](#9c3f)  
· [What is an Import Map?](#57ef)  
· [Exploring the Full Potential of Import Maps and Overrides](#2f22)  
· [Nx Enables Scalable Micro Frontend Architecture](#e1ed)  
· [What about Native Federation?](#a8b4)  
· [Final Thoughts](#656e)

## Real Story!

Just to give you more context, I led the migration of several [AngularJS](https://angularjs.org/) applications to the newer [Angular](https://angular.dev/) Framework. My client finally decided to make that move following the AngularJS deprecation announcement (stay up to date please 🙏)️.
...
Let’s start with a short definition: the micro frontend architecture involves **breaking down** a frontend application into **smaller**, more **manageable** pieces — each responsible for a **distinct feature** or **domain** of your application. It’s often compared to the [microservices concept](https://avinetworks.com/glossary/microservice/) but at the frontend layer.
...
> For more information, I recommend checking out the [MDN Web Docs](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/script/type/importmap) and the [proposal’s GitHub repository](https://github.com/WICG/import-maps?tab=readme-ov-file).
...
At this stage, the CI will build your app and generate new bundles for the modified micro frontend. Additionally, you can generate an [affected](#c8c8) `importmap.json` with the updated bundles.
...
I won’t delve into all the benefits of Nx, a topic I’ve extensively covered in previous writings. I’ll encourage you to have a look at the [Nx website](https://nx.dev/) for more detailed information.
...
nx.dev](https://nx.dev/concepts/more-concepts/why-monorepos?source=post_page-----0b8e2c07568a---------------------------------------#monorepos)
...
nx.dev](https://nx.dev/ci/features/affected?source=post_page-----0b8e2c07568a---------------------------------------#run-only-tasks-affected-by-a-pr)
...
nx.dev](https://nx.dev/concepts/more-concepts/dependency-management?source=post_page-----0b8e2c07568a---------------------------------------)
...
github.com](https://github.com/angular-architects/module-federation-plugin/issues/489?source=post_page-----0b8e2c07568a---------------------------------------)
...
github.com](https://github.com/jogelin/nx-nf?source=post_page-----0b8e2c07568a---------------------------------------)
...
### [Joel Denning](https://medium.com/u/a142a504a37c?source=post_page---user_mention--0b8e2c07568a---------------------------------------)
...
![single-spa framework from Joel Denning]()

### [Manfred Steyer](https://medium.com/u/acb3f1945710?source=post_page---user_mention--0b8e2c07568a---------------------------------------)
...
![Micro frontend and moduliths with Angular from Manfred Steyer]()

## Related

[## 🌊 The Nx Series

### A Compilation of Useful Articles on Harnessing the Power of Nx with Best Conventions

jgelin.medium.com](https://jgelin.medium.com/the-nx-series-d83b92185539?source=post_page-----0b8e2c07568a---------------------------------------)
